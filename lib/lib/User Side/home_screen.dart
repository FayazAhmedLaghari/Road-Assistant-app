              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Icon(Icons.broken_image_outlined, size: 40, color: Colors.black),
                  ],
                ),
              ),
            ),
              ...
              builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
                ...
                return Column(
                  children: snapshot.data!.docs.map((doc) {
                    ...
                    String companyName = data.containsKey('name') ? data['name'] : 'No name available';
                    String companyLocation = data.containsKey('address') ? data['address'] : 'No location available';
                        ...
                        child: Column(
                          ...
                          children: [
                            BuildServiceCard(
                              ...
                              address: companyLocation, // Display company location
                              rating: 4.5, // Assuming a rating, you can replace with actual data if available
                            ),
                            SizedBox(height: 8),
                          ],
                        ),
